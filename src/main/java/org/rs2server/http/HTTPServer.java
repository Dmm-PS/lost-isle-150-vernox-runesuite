...
public class HTTPServer {
	...
	public static void start() {
		...
		WorldList w1 = new WorldList(1, 33, "104.198.75.197", "Economy", 43594);//43594
		WorldList w2 = new WorldList(2, 33, "149.56.143.0", "Development", 43595);//40002
		...
		log.info("Vernox WebServer has loaded sucessfuly.");
	}
}
