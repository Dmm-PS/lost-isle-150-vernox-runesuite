...
public class Constants {
	 ...
	 */
	public static final String WEBSITE_URL = "http://Vernox.com";
	//websites online
	 ...
	 * The exp modifier
	 */
	public static final int EXP_MODIFIER = 10;//10 20
	
	/**
	 * Combat EXP Modifier
	 */
	public static final int COMBAT_EXP = 20;
	 ...
	 */
	public static final int MESSAGE_OF_THE_WEEK_SCREEN = 17;//17
	
	/**
	 * The server's name.
	 */
	public static final String SERVER_NAME = "Vernox";
	...
	public static final Location BRIMHAVEN_DUNGEON = Location.create(2697, 9482, 0);
	public static final Location FREMENNIK_SLAYER_DUNGEON = Location.create(2808, 10003, 0);
	public static final Location WATERFALL = Location.create(2575, 9862, 0);
	...
	public static final Location MEMBER_ZONE = Location.create(1267, 3505, 0);
	...
	public static final Location DORG = Location.create(2719, 5320, 0);
	...
	public static final Location DAGANNOTHKINGS = Location.create(2446, 10147, 0);
	...
	public static final Location TZHAAR_ENTRANCE = Location.create(2480, 5175, 0);
	...
	public static final Item STARTER_ITEMS[] = new Item[] {
		new Item(8007, 10), new Item(8008, 10), new Item(8010, 10), new Item(841, 1), new Item(1351, 1), new Item(2347, 1),  new Item(590, 1), new Item(5605, 1), new Item(1323, 1), new Item(122, 10), new Item(116, 10)
	};
	...
	public static int[][] stringItems = {{1673, 1692}, {1675, 1694}, {1677, 1696}, {1679, 1698}, {1681, 1700}, {1683, 1702}, {6579, 6581}, {1714, 1716}, {19501, 19504}};
	...
	private static final int[] PLAYER_BOUND_ITEMS = { 12608, 12610, 12612, 12648, 12921, 12940, 12939,
			...
			5208, 4190, 3658, 1946, 2692, 9113, 9558, 10499, 10737, 9655, 9234,
			...
			3635, 3636, 3637, 3638, 3639, 12954, 13280, 13281, 13329, 13330, 13331, 13332, 13333, 13334, 13335, 13336, 13337, 13338, 13124 };
	...
	public static final String[] WELCOME_SCREEN = {"Welcome to Vernox"};
	...
	public static boolean hasMaxCape(Mob mob) {
		return mob.getEquipment() != null && (mob.getEquipment().contains(13280) || mob.getEquipment().contains(13329) || mob.getEquipment().contains(13331) || mob.getEquipment().contains(13333) || mob.getEquipment().contains(13335) ||  mob.getEquipment().contains(13337));
	}
