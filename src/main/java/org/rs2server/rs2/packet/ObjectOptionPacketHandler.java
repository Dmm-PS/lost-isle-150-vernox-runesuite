	...
	private void handleOption1(final Player player, Packet packet) {
		...
		if (permissionService.is(player, PermissionService.PlayerPermissions.ADMINISTRATOR)) {
			player.getActionSender()
					.sendMessage("<col=6e9118>ObjDebug1 - " + obj.getId() + "Location: " + obj.getLocation()
							+ ", Face: " + obj.getDirection() + ", Type: " + obj.getType() + "("
							+ GameObjectType.forType(obj.getType()) + ")");
		}
			...
			action = new Action(player, 0) {
				...
				public void execute() {
					...
					if (ClickEventManager.getEventManager().handleObjectOption(player, obj.getId(), obj,
						...
						switch (objectId) {
						case 17385:
							player.setTeleportTarget(Location.create(2546, 3551, 0));
							break;
						case 26762:
						...
						case 14918:
							if (player.getSkills().getLevel(Skills.AGILITY) < 74) {
								player.getActionSender()
										.sendMessage("<col=ff0000>You need an Agility level of 74 to use this shortcut.");
								return;
							}
						...
						case 28849:
							if (player.getSkills().getLevel(Skills.AGILITY) < 63) {
								player.getActionSender()
										.sendMessage("<col=ff0000>You need an Agility level of 63 to use this shortcut.");
								return;
							}
						...
						if (!player.getInventory().contains(13445)) {
							player.getActionSender().sendMessage("<col=ff0000>A dark power energizes the Essence block.");
							return;
						}
						...
						case 26813:
							...
							player.getActionSender().sendCS2Script(917, new Object[] { -1, -1 }, "ii")
									...
									.sendCS2Script(609,
											...
											"siidfiiI")
									.sendCS2Script(610,
											new Object[] { 22609930, "http://Vernox.com/forums",
									...
									.sendCS2Script(610,
											new Object[] { 22609930,
													"http://Vernox.com/forums/index.php?/forum/5-development/",
													"Click here to visit Vernox's server development." },
											"ssI")
									.sendCS2Script(610,
											new Object[] { 22609930,
													"http://Vernox.com/forums/index.php?/forum/6-game-updates/",
													"Click here to visit Vernox's latest game updates." },
											"ssI")
									.sendCS2Script(610,
											new Object[] { 22609930,
													"http://Vernox.com/forums/index.php?/forum/7-behind-the-scenes/",
													"Click here to visit Vernox's behind the scenes" },
											"ssI")
									.sendCS2Script(610,
											new Object[] { 22609930,
													"http://Vernox.com/forums/index.php?/forum/8-site-updates/",
													"Click here to visit Vernox's site updates" },
											"ssI")
									...
									// "IIs")
									.sendString(345, 2, "<img=35>Website: Vernox.com")
						...
						case 24303:// warrior guild level 3
							...
							break;
						case 11835:
							player.setTeleportTarget(Constants.TZHAAR_ENTRANCE);
							break;
						case 11836:
...
//							break;
	...
	private void handleOption2(final Player player, Packet packet) {
		...
		// WallSafe safe = ThievingAction.WALL_SAFE.get(objectId);
