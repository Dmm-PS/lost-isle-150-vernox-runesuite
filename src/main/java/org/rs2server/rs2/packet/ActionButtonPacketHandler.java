                ...
                switch (button) {
                    ...
                    case 24:
                        ...
                        switch (SpellBook.forId(player.getCombatState().getSpellBook())) {
                            case MODERN_MAGICS:
                                if (player.getEquipment().get(Equipment.SLOT_WEAPON).getId() == 4170 || player.getEquipment().get(Equipment.SLOT_WEAPON).getId() == 11791 || player.getEquipment().get(Equipment.SLOT_WEAPON).getId() == 12904) {
                    ...
                    case 1:
                        switch (button) {
                            case 6: // Helmet check
                                ...
                                if (helmet.getId() == 11864 || helmet.getId() == 11865 || helmet.getId() == 19639 || helmet.getId() == 19643 || helmet.getId() == 19647 || helmet.getId() == 19641 || helmet.getId() == 19645 || helmet.getId() == 19649) {
                    ...
                    case 141:
                        ...
                        if (player.isInWilderness()) {
                            if (player.getCombatState().getLastHitTimer() > System
                                ...
                                player.getActionSender().sendMessage("You may not teleport in combat without a Law Rune!");
                            }
                        } else {
                            player.teleport(Constants.HOME_TELEPORT, 3, 3, false);
                        }
