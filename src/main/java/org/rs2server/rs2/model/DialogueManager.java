...
public class DialogueManager {
	...
	public static void openDialogue(final Player player, int dialogueId) {
		...
		case 3667:
			...
			break;
		case 3668:
			player.getActionSender().sendDialogue("Prince Brand", DialogueType.NPC, 3666, FacialAnimation.HAPPY, "This land is the Extreme Donator Zone, only for the most elite supporters of Vernox, you'll find an abundance of activities you can do here.");
		...
		case 403:
			...
			player.getActionSender().sendMessage("Thank you for supporting Vernox");
			break;
		case 404:
			player.getActionSender().removeChatboxInterface();
		...
		case 25500:
			player.getActionSender().sendDialogue("Vernox Teleports", ActionSender.DialogueType.TELEPORT_INTERFACE, -1, null, "Varrock|Edgeville|Rock crabs|Barrows");
