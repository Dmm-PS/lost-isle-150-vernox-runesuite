...
public class Player extends Mob implements Persistable {
	...
	/**
	 * The players construction class,
	 * containing the players house etc.
	 */
...
//    public int toxicItem = -1;
	...
	public void teleport(Location location, int xOffset, int yOffset, boolean npcTeleport) {
		...
		playGraphics(Graphic.create(gfx, 0, getCombatState().getSpellBook() == MagicCombatAction.SpellBook.ANCIENT_MAGICKS.getSpellBookId() ? 0 : 0));//48  0 : 100
