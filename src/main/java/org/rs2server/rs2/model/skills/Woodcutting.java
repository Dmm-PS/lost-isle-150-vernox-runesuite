...
public class Woodcutting extends HarvestingAction {
	...
	public enum Tree {
		 ...
		 * Willow tree.
		 */
		WILLOW(1519, 30, 67.5, 22, 16, new int[]{1750, 1758, 7480, 7422, 7482, 7424}, 7000),
...
//		this.petRate = petRate;
		 ...
		 * Yew tree.
		 */
		YEW(1515, 60, 175, 120, 16, new int[]{1753, 7419}, 4000),
		 ...
		 * Dramen tree
		 */
		REDWOOD(19669, 90, 380, 380, 10, new int[]{28859}, 5000),
	...
	public double getExperience() {
		...
		if (random == 0) {
			...
			if (player.getPet() != null) {
				...
				World.getWorld().sendWorldMessage("<col=880000><img=33>Drops: <col=880000>" + player.getName() + " has just received 1x Beaver.");
				return tree.getExperience();
			}
		}
		return tree.getExperience();
