	...
	public void addExperience(Mob attacker, int damage) {
		...
		if (attacker.getCombatState().getCombatStyle() == CombatStyle.DEFENSIVE_AUTOCAST) {
			attacker.getSkills().addExperience(Skills.MAGIC,
					(damage) * Constants.COMBAT_EXP);//1.33
			attacker.getSkills().addExperience(Skills.DEFENCE,
					(damage) * Constants.COMBAT_EXP);
		} else {
			attacker.getSkills().addExperience(Skills.MAGIC,
					(damage) * Constants.COMBAT_EXP);
		}
...
//		mob.getActionSender().sendSidebarInterfaces();
	...
	public static enum Spell {
		 ...
		 * Paddewwa teleport.
		 */
		PADDEWWA_TELEPORT(83, 54, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 * Senntisten teleport.
		 */
		SENNTISTEN_TELEPORT(84, 60, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 * Kharyrll teleport.
		 */
		KHARYRLL_TELEPORT(85, 66, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 * Lassar teleport.
		 */
		LASSAR_TELEPORT(86, 72, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 * Dareeyak teleport.
		 */
		DAREEYAK_TELEPORT(87, 78, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 */
		CARRALLANGAR_TELEPORT(88, 84, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 * Annakarl teleport.
		 */
		ANNAKARL_TELEPORT(89, 90, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 * Ghorrock teleport.
		 */
		GHORROCK_TELEPORT(90, 96, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[]{new Item(LAW_RUNE, 2),
		 ...
		 */
		HOME_TELEPORT_ANCIENT(91, 1, SpellBook.ANCIENT_MAGICKS,
				SpellType.NON_COMBAT, new Item[0], "homeTeleport", null),
		
		/**
		 * Home teleport modern
		 */
		HOME_TELEPORT_ARCEUUS(139, 1, SpellBook.ARCEUUS_MAGICS,
				SpellType.NON_COMBAT, new Item[0], "homeTeleport", null),
