...
public class TeleportManager {
	...
	public static boolean handleTeleportAction(Player player, int option) {
		...
		case 13:
			...
			break;
		case 14:
			player.getActionSender().sendMessage("Teleports that take you to various Dungeon locations.");
			player.getActionSender().closeAll();
			break;
		case 15:
...
//			player.getActionSender().sendMessage("Teleporting to Fishing Guild.");
		...
		case 25:
			...
			break;
		case 26://Minigames
			player.getActionSender().sendMessage("Teleports that take you to various Minigame locations.");
			player.getActionSender().closeAll();
			break;
		...
		case 34:
			...
			player.getActionSender().closeAll();
			player.getActionSender().sendMessage("<col=ff>Welcome to the Woodcutting guild.");
			break;
		case 35:
		...
		case 51:
			...
			break;
		case 52:
			player.getActionSender().sendMessage("Teleports that take you to various Boss locations.");
			player.getActionSender().closeAll();
			break;
		case 53:
		...
		case 62:
			...
			break;
		case 63:
			player.getActionSender().sendMessage("Teleports that take you to various Wilderness locations.");
			player.getActionSender().closeAll();
			break;
		case 64:
